...
3. **NuGet Vulnerability Mitigation**:
   - Verify that patched assemblies in `/app` match secure versions:
     - `Azure.Identity` >= 1.11.4 (remediates CVE-2023-36414, CVE-2024-29992, CVE-2024-35255)
     - `Microsoft.Data.SqlClient` >= 3.1.5 (remediates CVE-2024-0056)
     - `System.Drawing.Common` >= 4.7.2 (remediates CVE-2021-24112)
4. **Secret Scanning**:
